...
export class NutritionPage implements OnInit {
  ...
  async filterPopover(ev: any) {
    ...
    popover.onDidDismiss().then((data) => {
      ...
      that.filterUserList(that.model.statusFilterVal, that.model.physicianFilterVal, that.model.typeFilterVal, that.model.dateFrom,
              that.model.dateTo,that.model.timeFrom,that.model.timeTo);
    })
    return await popover.present();
  }
